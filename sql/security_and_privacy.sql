...
GRANT SELECT, INSERT, UPDATE, DELETE
    ON letterboxd.movies          TO 'role_content_manager';
GRANT SELECT, INSERT, UPDATE, DELETE
    ON letterboxd.genres          TO 'role_content_manager';
GRANT SELECT, INSERT, UPDATE, DELETE
    ON letterboxd.movies_genres   TO 'role_content_manager';
GRANT SELECT, INSERT, UPDATE, DELETE
    ON letterboxd.studios         TO 'role_content_manager';
GRANT SELECT, INSERT, UPDATE, DELETE
    ON letterboxd.movies_studios  TO 'role_content_manager';
GRANT SELECT, INSERT, UPDATE, DELETE
    ON letterboxd.languages       TO 'role_content_manager';
GRANT SELECT, INSERT, UPDATE, DELETE
    ON letterboxd.movies_languages TO 'role_content_manager';
GRANT SELECT, INSERT, UPDATE, DELETE
...
GRANT SELECT, INSERT, UPDATE, DELETE
    ON letterboxd.movies_releases TO 'role_content_manager';

-- Cast & crew info
GRANT SELECT, INSERT, UPDATE, DELETE
    ON letterboxd.people          TO 'role_content_manager';
GRANT SELECT, INSERT, UPDATE, DELETE
    ON letterboxd.cast_people     TO 'role_content_manager';
GRANT SELECT, INSERT, UPDATE, DELETE
    ON letterboxd.crew_people     TO 'role_content_manager';
...
GRANT SELECT, INSERT, UPDATE, DELETE
    ON letterboxd.movie_lists_movies TO 'role_content_manager';
GRANT SELECT, INSERT, UPDATE, DELETE
